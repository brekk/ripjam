      ...
      if (!aS && !bS) {
        ...
        if (aF && bF) {
          fork$1(
            ...
            ap$1(aIsTheSame)(ap$1(asB)(resolve(x => y => ({ x, y }))))
          );
        } else {
          aIsTheSame
...
exports.hook = hook;
exports.riptestWithConfiguration = riptestWithConfiguration;
exports.sameImplementation = sameImplementation;
exports.sameInterface = sameInterface;
exports.testAndExpectDefined = testAndExpectDefined;
